...
import magscope
from magscope.ipc_commands import Command, register_command
...
class FakeLinearMotor(magscope.HardwareManagerBase):
    ...
    @register_command(MoveLinearMotorCommand)
    ...
    @register_command(MoveLinearMotorForceCommand)
    ...
    @register_command(ForceRampCommand)
