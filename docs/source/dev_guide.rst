...
with a handler decorated by :func:`magscope.register_command`. MagScope
...
from magscope import Command, HardwareManagerBase, register_command
...
class LaserManager(HardwareManagerBase):
    @register_command(ToggleLaserCommand)
