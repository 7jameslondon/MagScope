...
from magscope.scripting import registerwithscript
...
class BeadLockManager(ManagerProcessBase):
    ...
    # TODO @registerwithscript('do_xy_lock')
    ...
    # TODO @registerwithscript('do_z_lock')
    ...
    # TODO @registerwithscript('set_xy_lock_on')
    ...
    # TODO @registerwithscript('set_xy_lock_interval')
    ...
    # TODO @registerwithscript('set_xy_lock_max')
