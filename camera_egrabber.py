"""EGrabber-backed camera adapter for MagScope.

This module is intentionally tracked in the repository so both VSCode and
PyCharm resolve the same camera integration code path.
"""
...
class EGrabberCamera(CameraBase):
    ...
    def __init__(self):
        super().__init__()
        self.gentl = None
        self.egrabber: egrabber.EGrabber | None = None  # type: ignore[attr-defined]
